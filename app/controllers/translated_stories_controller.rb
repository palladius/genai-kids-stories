class TranslatedStoriesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @translated_story.save
        format.html { redirect_to translated_story_url(@translated_story), notice: "Translated story was successfully created." }
  ...
  def update
    respond_to do |format|
      if @translated_story.update(translated_story_params)
        format.html { redirect_to translated_story_url(@translated_story), notice: "Translated story was successfully updated." }
  ...
  private
    ...
    def translated_story_params
      params.require(:translated_story).permit(:name, :user_id, :story_id, :language, :client_id, :paragraph_strategy, :internal_notes, :genai_model)
    end
end
