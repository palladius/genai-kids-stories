...
Note: this breaks on Cloud RUn:

Errno::ENOENT: No such file or directory @ rb_sysopen - private/sa.json
https://screenshot.googleplex.com/7jQrAfaSdfaggdM

private/sa.json

in CRun its /secrets/sa.json
